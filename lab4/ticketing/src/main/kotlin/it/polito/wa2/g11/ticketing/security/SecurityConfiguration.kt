...
class WebSecurityConfig(private val jwtAuthConverter: JwtAuthConverter) {
    ...
    fun securityFilterChain(http: HttpSecurity): SecurityFilterChain {
        http.authorizeHttpRequests()
            ...
            .requestMatchers(HttpMethod.GET, "/test/expert").hasAnyRole(EXPERT, MANAGER)
            .requestMatchers(HttpMethod.GET, "/test/client")
            .hasAnyRole(CLIENT, EXPERT, MANAGER)
            ...
            .anyRequest().hasRole(MANAGER).and().csrf().disable()
